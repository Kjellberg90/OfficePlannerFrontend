...
const Map = () => {
    ...
    return (
        <Row>
            <Col className="d-flex align-items-center" style={{ height: 700, width: 800 }}>
                <svg
                ...
                >
                    ...
                    <g>
                        <path className="mapBase"
                            fill="#ffc72c"
                            d="M91.885 120.508l-.421-94.314 171.455-.671 1.032 96.35 93.485.369 787.674 3.112v181.104l-67.81-.377-.31 110.576 68.62-.66-.91 179.412-658.025-1.553-4.244 218.885-466.776-1.645.72-229.341 173.715-.352 2.941-194.496-78.608-85.505-25.364-.032 2.826-180.862z"
                            filter="url(#Filter)"
                        ></path>
                        ...
                        <g className="rooms" fill="#85d4ff">
                            ...
                            ></path>
                            <path className="inspired" onMouseOver={mouseOverRoom} onMouseLeave={mouseLeaveRoom}
                                d="M812.449 139.723h309.311c5.42 0 9.81 4.195 9.81 9.37v144.101c0 5.175-4.39 9.37-9.81 9.37H812.449c-5.414 0-9.803-4.195-9.803-9.37V149.093c0-5.175 4.389-9.37 9.803-9.37z"></path>
                            <path className="commitment" onMouseOver={mouseOverRoom} onMouseLeave={mouseLeaveRoom} d="M702.353 413.489h195.102c5.406 0 9.788 4.401 9.788 9.829v148.415c0 5.428-4.382 9.829-9.788 9.829H702.353c-5.406 0-9.789-4.401-9.789-9.829V423.318c0-5.428 4.383-9.829 9.789-9.829z">
                            </path>
