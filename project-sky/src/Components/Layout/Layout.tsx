...
import companyLogo from '../../shared/companylogo.svg'
      ...
      <Container className="headerContainer d-flex flex-column align-items-center">
        <Row className="layoutHeader d-flex justify-content-center align-items-center">
          <Col xs={12} md={4} className="layoutColumn">
            <Link to={"/start"}>
              {/* <img src={companyLogo} alt="company Logo" style={{ width: "100%", height: "100%", objectFit: "contain" }} className="companyLogo" /> */}
              <svg width="100%" height="100%" viewBox="0 0 417 125" version="1.1" xmlns="http://www.w3.org/2000/svg"  fill="#FFC72C" className="companyLogo">
